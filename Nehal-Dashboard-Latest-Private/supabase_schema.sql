...
-- Project: Project Command Center / Nehal Dashboard
...
DO $$ BEGIN
    CREATE TYPE source_enum AS ENUM ('LOCAL', 'ODOO', 'GOOGLE_SHEETS');
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
CREATE INDEX IF NOT EXISTS ix_projects_deadline_priority ON public.projects (deadline, priority);
...
-- 6. Server-Side RPC Functions for Database-Level Aggregations
